...
/*		array (
	...
	$cfg['ilibs'] = array (			
		array (																		
			'value'   	=> '/app/webroot/img/editorimage',												
			'text'    	=> '',
		),
		array (
			'value'   	=> '/app/webroot/img/editorimage', 				
	...
	$cfg['ilibs_dir'] 	   = array('/app/webroot/img/editorimage');	
	...
	$cfg['base_url'] 	= 'http://' . $_SERVER['SERVER_NAME'].':9663';							// base url; e.g. 'http://localhost/'	
