...
(function($){
	...
	$.extend($.fn,{
		...
		showDrag: function(e){
			...
			$('<div style="width:'+options.defaultWidth+'px;height:'+options.defaultHeight+'px"class="jTagDrag"><div class="jTagSave"><p style="text-align:center;margin-left:-30px;padding-top:3px;">Type Friends Name to Tag</p><div class="jTagInput"><input type="text" id="jTagLabel" placeholder="Type Friends Name to Tag"></div><div class="jTagSaveClose"></div><div class="jTagSaveBtn"></div><div style="clear:both"></div></div>').appendTo(overlay);
