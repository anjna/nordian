...
(function($){
	...
	$.extend($.fn,{
		...
		showDrag: function(e){
			...
			$('<div style="width:'+options.defaultWidth+'px;height:'+options.defaultHeight+'px"class="jTagDrag"><div class="jTagSave"><div class="jTagAutocompleteContainer"><div class="jTagInput"><input type="text" id="jTagLabel"></div><div class="jTagSaveClose"></div><div class="jTagSaveBtn"></div><div style="clear:both"></div></div></div>').appendTo(overlay);
			...
			if(options.autoComplete){
				...
				/*$("#jTagLabel",container).autocomplete({
					...
					select: function(event, ui) {
						...
						$("#jTagLabel",container).val(selectedObj.label);
						$('#hiddenUserId').val(selectedObj.value);
						return false;
					}
				});*/
				...
				$("#jTagLabel",container).autocomplete({
					...
					var inner_html = '<span class="lt"><img alt="" src="/img/'+item.image+'"></span><span class="lt" style="margin-left:5px;"><span class="text">'+item.label+'</span><span class="subtext">'+item.location+'</span></span><span class="clear"></span>';
					
					return $( "<li></li>" )
					.data( "item.autocomplete", item )
					.append( $( "<a></a>" ).html( inner_html ) )
					.appendTo( ul );	
				};
